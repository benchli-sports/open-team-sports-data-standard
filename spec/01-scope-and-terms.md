...
- Officiating systems and rule enforcement
- Deep medical/health data
- Anti-doping or disciplinary records (can be added via extensions by implementers)

## Key terms
- **Player**: a person who can belong to one or more teams.
- **Membership**: the relationship between a Player and Team (role/status).
- **Event**: a scheduled item (training, meeting, travel, fundraiser, etc.).
